...
<link rel="stylesheet" href="css/stitches-0.0.31-min.css">
...
<script src="js/stitches-0.0.31-min.js"></script>
{% endhighlight %}
...
**The latest release, 0.0.31, is [available here](dist/stitches-0.0.31.zip).**
