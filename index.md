...
<link rel="stylesheet" href="http://draeton.github.com/stitches/stitches/build/css/stitches-0.4.9-min.css">
...
{% highlight html %}
<link rel="stylesheet" href="css/stitches-0.4.9-min.css">

<script src="js/jquery-1.7.1.min.js"></script>
<script src="js/modernizr-2.0.6.min.js"></script>

<script src="js/stitches-0.4.9-min.js"></script>
{% endhighlight %}
...
**The latest release, 0.4.9, is [available here](http://draeton.github.com/stitches/stitches/dist/stitches-0.4.9.zip).**
...
<script>
Modernizr.load({
    load: "/stitches/stitches/build/js/stitches-0.4.9-min.js",
    complete: function () {
        $(function () {
