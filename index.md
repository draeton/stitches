...
<link rel="stylesheet" href="css/stitches-0.0.27-min.css">
...
<script src="js/stitches-0.0.27-min.js"></script>
{% endhighlight %}
...
**The latest release, 0.0.27, is [available here](dist/stitches-0.0.27.zip).**
